...
function loadSearchPageState(): SearchPageState | null {
    ...
    try {
        ...
        const nextSource = availableSources.includes(
            ...
            : "auto";
        const nextMode =
            parsed.resultMode === "organized" ? "organized" : "list";
...
export default function SearchPage() {
    ...
    const organizedSwitchTimerRef = useRef<ReturnType<
        typeof setTimeout
    > | null>(null);
    ...
    const handleLike = async (paper: SearchResultItem) => {
        ...
        setLikeOverrides((current) => ({
            ...current,
            [paperId]: optimisticLiked,
        }));
        setResults((current) =>
            current.map((p) =>
                p.external_id === paperId
                    ? { ...p, is_in_library: optimisticLiked }
                    : p,
            ),
        );
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3">
                        ...
                        {resultMode === "organized" && (
                            <button
                                type="button"
                                onClick={() =>
                                    void handleChangeResultMode("list")
                                }
